...
const val BACKGROUND_TIMEOUT_MIN = 2_400L
const val BACKGROUND_ADDITIONAL_TIMEOUT = 1_200L
const val BACKGROUND_TIMEOUT_MAX = 7_200L
const val BACKGROUND_MAX_RETRY = 8
